 ...
 */
@Component
public class IncrDataSyncPostProcessor implements TaskPostProcessor {
    @Override
    ...
    public void postProcessAfterExecute(TaskSegment taskSegment, Integer resultSize) {
        PerfUtil.countSuccess(TaskUtil.getPrefixWithOutUnderLine(taskSegment.getSnapshotValue()), TaskModeEnum.INC_SYNC, resultSize);
    }


    @Override
    public void afterPropertiesSet() throws Exception {
        TASK_MANAGER.put(TaskModeEnum.INC_SYNC, this);
    }
}
